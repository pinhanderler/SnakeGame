...
Gri yılan zehirlidir, kanınızı kaynatır (hız++) fakat 5 kere zehirlenirseniz ölürsünüz.
...
<h1 id="scorem"></h1>
<p><input id="submit" type="submit" name="login" value="KAYDET" style="font:50px Arial;"/></p>
</form>
</font>
</center>
</div>
...
class SnakeGame {
  ...
  draw() {
	...
	// Zehirli Yılanın herbir karesini sırayla ekrana çiziyoruz
    this.context.fillStyle = 'rgb(256, 256, 256, 0.5)';
    this.trail2.forEach(t2 => {
